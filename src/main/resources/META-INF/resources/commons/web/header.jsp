				...
				<ul class="list-unstyled list-inline pull-right">
					...
					<c:choose>
						<c:when test="${not empty sessionScope.account}">
							<li><a href="/BT5_springboot3/views/Update.jsp">My Account</a></li>
						...
						<c:otherwise>
							<li><a href="/BT5_springboot3/views/SignUp.jsp">Sign up</a></li>
	                        <li><a href="/BT5_springboot3/views/Login.jsp">Log In</a></li>
						</c:otherwise>
					</c:choose>
